package com.kidd.projectbase.custom.tooltip;
...
public class ToolTipView implements ViewTreeObserver.OnPreDrawListener, View.OnClickListener {
    ...
    public void showDelayed(long milliSeconds) {
        new Handler(Looper.getMainLooper()).postDelayed(this::show, milliSeconds);
    }
    ...
    public boolean onPreDraw() {
        ...
        if (gravity == Gravity.TOP || gravity == Gravity.BOTTOM) {
            ...
            pivotX = gravity == Gravity.START ? anchorLeft : leftPadding;
        ...
        public ToolTipView build() {
            ...
            if (gravity == Gravity.START || gravity == Gravity.END) {
                if (anchorView.getLayoutDirection() == View.LAYOUT_DIRECTION_RTL) {
                    gravity = gravity == Gravity.START ? Gravity.END : Gravity.START;
                } else {
